  ...
  if (!recipe) {
    return (
      <div className="p-4 text-center">
        ...
        <button
          className="mt-4 bg-blue-600 text-white px-4 py-2 rounded" onClick={() => navigate(-1)}
        >
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col gap-2">
        <button onClick={handleUseRecipe} className="bg-green-600 text-white py-2 px-4 rounded flex items-center justify-center gap-2">
          <CookingPot className="w-4 h-4" /> Use Recipe
        </button>
        <button onClick={handleAddToDiary} className="bg-yellow-500 text-white py-2 px-4 rounded flex items-center justify-center gap-2">
          <NotebookPen className="w-4 h-4" /> Add to Diary
        </button>
        <button onClick={handleSaveFavorite} className="bg-pink-500 text-white py-2 px-4 rounded flex items-center justify-center gap-2">
